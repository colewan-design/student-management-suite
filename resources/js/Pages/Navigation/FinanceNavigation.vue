<template>
    ...
    >
     ...
     <v-list-item to="/staff_dashboard">
        <v-list-item-icon>
          <v-icon style="color: green;">mdi-domain</v-icon>
        </v-list-item-icon>
     ...
     <v-list-item to="/finance_officer_dashboard">
        <v-list-item-icon>
          <v-icon style="color: seagreen;">mdi-finance</v-icon>
        </v-list-item-icon>
        <v-list-item-title>Finance Officer Dashboard</v-list-item-title>
      </v-list-item>

      <v-list-item to="/finance_document_page">
          <v-list-item-icon>
            <v-icon style="color: mediumseagreen;">mdi-file-sign</v-icon>
          </v-list-item-icon>
